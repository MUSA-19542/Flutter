...
//<============================module 6=============================>
  ...
  uploadItem () async
  {
    if(SelectedImage==null)
      {
        popup("Please Upload The Image", 13);
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          centerTitle: true,
            title: Text("Add Item ",style: AppWidget.SemiboldTextFieldStyleCustom(golden, 25),),
      ),
            ...
            child: Center(
              child: Material(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text("Add Item " ,style:AppWidget.SemiboldTextFieldStyleCustom(Colors.white, 18),)),
                    ),
                  ),
            ),
          ),
